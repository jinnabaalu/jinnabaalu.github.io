...
Part-3 [Git Branching for Contributors]({{ site.baseurl }}/branch-mangement)

Part-4 [Git for developers]({{ site.baseurl }}/git-developer-commands)

Part-5 [Life Cycle of a branch]()

Part-6 Model of Branching (master, develop, feature, hotfix)

Part-7 [Git for DevOps]({{ site.baseurl }}/Git-Cheet-Sheet)

...
![Bibucket Webhook](https://vibhuvioio.com/assets/img/bitbucket_webhook.png)

Title: Test Webhook

URL: `http://cicd.vibhuvioio.com/bitbucket-hook/` or `http://YOUR_JENKINS_SERVER:PORT/bitbucket-hook/`
